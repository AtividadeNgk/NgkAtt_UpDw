...
async def send_upsell(context, user_id):
    ...
    keyboard = [
        [
            InlineKeyboardButton('✅ Aceitar', callback_data=f'upsell_aceitar_{payment_id}'),
...
async def send_downsell(context, user_id):
    ...
    keyboard = [
        [
            InlineKeyboardButton('✅ Aceitar Oferta', callback_data=f'downsell_aceitar_{payment_id}'),
